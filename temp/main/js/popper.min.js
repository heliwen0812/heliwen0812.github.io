!function(e, t) {
    ...
    function L(e) {
        var t, n, o = {};
        try {
            v(10) ? (o = e.getBoundingClientRect(),
            t = E(e, "top"),
            n = E(e, "left"),
            o.top += t,
            o.left += n,
            o.bottom += t,
            o.right += n) : o = e.getBoundingClientRect()
        } catch (e) {}
        var r, i = {
            left: o.left,
            top: o.top,
        ...
        }, s = "HTML" === e.nodeName ? x(e.ownerDocument) : {}, f = s.width || e.clientWidth || i.width, a = s.height || e.clientHeight || i.height, p = e.offsetWidth - f, l = e.offsetHeight - a;
        return (p || l) && (p -= u(r = y(e), "x"),
        l -= u(r, "y"),
        i.width -= p,
        i.height -= l),
        O(i)
    ...
    function T(e, t, n) {
        ...
        return h.marginTop = 0,
        h.marginLeft = 0,
        !r && i && (d = parseFloat(p.marginTop),
        ...
        h.marginTop = d,
        h.marginLeft = c),
        (r && !o ? t.contains(a) : t === a && "BODY" !== a.nodeName) && (h = function(e, t, n) {
            var o = 2 < arguments.length && void 0 !== n && n
              , r = E(t, "top")
              , i = E(t, "left")
              , s = o ? -1 : 1;
    ...
    function c(e, t, n, o, r) {
        var i, s, f, a, p, l = 4 < arguments.length && void 0 !== r && r, u = {
            top: 0,
            left: 0
        }, d = l ? D(e) : b(e, g(t));
        ...
        }(d, l) : ("scrollParent" === o ? "BODY" === (i = m(h(t))).nodeName && (i = e.ownerDocument.documentElement) : i = "window" === o ? e.ownerDocument.documentElement : o,
        s = T(i, d, l),
        "HTML" !== i.nodeName || function e(t) {
            ...
            var o = h(t);
            return !!o && e(o)
        }(d) ? u = s : (a = (f = x(e.ownerDocument)).height,
        p = f.width,
    ...
    function C(e, n, t) {
        return (void 0 === t ? e : e.slice(0, function(e, t, n) {
            ...
            e.enabled && i(t) && (n.offsets.popper = O(n.offsets.popper),
        ...
        modifiers: {
            shift: {
                ...
                fn: function(e) {
                    ...
                    return l && (n = (t = e.offsets).reference,
                    o = t.popper,
                    s = (r = -1 !== ["bottom", "top"].indexOf(p)) ? "width" : "height",
                    f = {
            ...
            offset: {
                ...
                fn: function(e, t) {
                    var n = t.offset
                      ...
                      , f = o.split("-")[0]
                      , a = p(+n) ? [+n, 0] : P(n, i, s, f);
                    return "left" === f ? (i.top += a[0],
                    i.left -= a[1]) : "right" === f ? (i.top += a[0],
                    i.left += a[1]) : "top" === f ? (i.left += a[0],
                    i.top -= a[1]) : "bottom" === f && (i.left += a[0],
                    i.top += a[1]),
                    e.popper = i,
                    e
                },
                ...
                fn: function(e, o) {
                    ...
                    var p = o.priority
                      ...
                      , u = {
                        primary: function(e) {
                            var t = l[e];
                            return l[e] < a[e] && !o.escapeWithReference && (t = R(l[e], a[e])),
                            S({}, e, t)
                        },
                        secondary: function(e) {
                            var t = "right" === e ? "left" : "top"
                              , n = l[t];
                            return l[e] > a[e] && !o.escapeWithReference && (n = W(l[t], a[e] - ("right" === e ? l.width : l.height))),
                            S({}, t, n)
                        }
                    };
            ...
            keepTogether: {
                ...
                fn: function(e) {
                    var t = e.offsets
                      ...
                      , a = s ? "left" : "top"
                      , p = s ? "width" : "height";
                    return n[f] < i(o[a]) && (e.offsets.popper[a] = i(o[a]) - n[p]),
            ...
            arrow: {
                ...
                fn: function(e, t) {
                    ...
                    var m = f[u] + f[p] / 2 - h / 2
                      ...
                      , w = R(W(s[p] - h, w), 0);
                    return e.arrowElement = o,
                    e.offsets.arrow = (S(n = {}, u, I(w)),
                    S(n, d, ""),
                    n),
                    e
                },
            ...
            flip: {
                ...
                fn: function(g, v) {
                    ...
                    return x.forEach(function(e, t) {
                        ...
                        w = g.placement.split("-")[0],
                        y = F(w);
                        var n, o = g.offsets.popper, r = g.offsets.reference, i = j, s = "left" === w && i(o.right) > i(r.left) || "right" === w && i(o.left) < i(r.right) || "top" === w && i(o.bottom) > i(r.top) || "bottom" === w && i(o.top) < i(r.bottom), f = i(o.left) < i(b.left), a = i(o.right) > i(b.right), p = i(o.top) < i(b.top), l = i(o.bottom) > i(b.bottom), u = "left" === w && f || "right" === w && a || "top" === w && p || "bottom" === w && l, d = -1 !== ["top", "bottom"].indexOf(w), c = !!v.flipVariations && (d && "start" === E && f || d && "end" === E && a || !d && "start" === E && p || !d && "end" === E && l), h = !!v.flipVariationsByContent && (d && "start" === E && a || d && "end" === E && f || !d && "start" === E && l || !d && "end" === E && p), m = c || h;
                        (s || u || m) && (g.flipped = !0,
                        (s || u) && (w = x[t + 1]),
                        m && (E = "end" === (n = E) ? "start" : "start" === n ? "end" : n),
                        g.placement = w + (E ? "-" + E : ""),
                        g.offsets.popper = X({}, g.offsets.popper, k(g.instance.popper, g.offsets.reference, g.placement)),
            ...
            inner: {
                ...
                fn: function(e) {
                    ...
                    return r[s ? "left" : "top"] = i[n] - (f ? r[s ? "width" : "height"] : 0),
                    e.placement = F(t),
            ...
            computeStyle: {
                ...
                fn: function(e, t) {
                    ...
                    var s, f, a = void 0 === i ? t.gpuAcceleration : i, p = w(e.instance.popper), l = L(p), u = {
                        position: r.position
                    }, d = A(e, window.devicePixelRatio < 2 || !J), c = "bottom" === n ? "top" : "bottom", h = "right" === o ? "left" : "right", m = B("transform"), g = "bottom" == c ? "HTML" === p.nodeName ? -p.clientHeight + d.bottom : -l.height + d.bottom : d.top, v = "right" == h ? "HTML" === p.nodeName ? -p.clientWidth + d.right : -l.width + d.right : d.left;
                    a && m ? (u[m] = "translate3d(" + v + "px, " + g + "px, 0)",
                    u[c] = 0,
                    u[h] = 0,
                    u.willChange = "transform") : (s = "bottom" == c ? -1 : 1,
                    f = "right" == h ? -1 : 1,
                    u[c] = g * s,
                    u[h] = v * f,
                    u.willChange = c + ", " + h);
